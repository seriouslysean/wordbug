...
// Mock functions for testing date validation
...
// Mock getAllWords for testing
const getAllWordsFromDir = (testWordsDir) => {
  if (!fs.existsSync(testWordsDir)) {return [];}
  ...
  describe('Date validation functions', () => {
    describe('isValidDate function', () => {
      ...
      it('should reject invalid dates', () => {
        ...
        // Note: JavaScript Date constructor is lenient - it adjusts invalid dates
        // For example, 2025-02-30 becomes 2025-03-02
        // So we focus on clearly invalid formats instead
        expect(isValidDate('2025-00-01')).toBe(false); // invalid month
        expect(isValidDate('2025-01-00')).toBe(false); // invalid day
      });
    });
